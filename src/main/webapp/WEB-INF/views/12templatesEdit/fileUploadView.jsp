...
<div class="row">
	<div class="form-group col-sm-12">
		...
		<label
			class="col-sm-3 control-label pull-left" for="form-field-username">范围</label>

		<div class="col-sm-9">
			<div class="form-group">
				<div class="col-sm-6">
					<label class="ace-file-input ace-file-multiple"> <input
						multiple="" type="file" id="shpFile" name="file"> <a class="remove"
...
<div class="row">
	<div class="form-group col-sm-12">
		<input type="hidden" name="zlzk"> <label
			class="col-sm-3 control-label pull-left" for="form-field-username">质量状况</label>
		<div class="col-sm-9">

			<div class="form-group">
				<div class="col-sm-6">
					<label class="ace-file-input ace-file-multiple"> <input
						multiple type="file" id="qualityFile" name="imgs"> <a class="remove"
						href="#"> <i class=" ace-icon fa fa-times"></i></a>
					</label>
