											...
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10 required" type="text" name="xmmc" 
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" id="swmc" name="swmc"
																placeholder="锁网名称">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" id="point" name="point"
																placeholder="点数">
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" id="pjwc" name="pjwc"
																placeholder="平均误差">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" id="zrbwc" name="zrbwc"
																placeholder="最弱边误差">
														</div>
													</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															...
															<input class="hide" type="text" name="zbxt"
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															...
															<input class="hide" type="text" name="level" placeholder="等级">
														</div>
													</div>
