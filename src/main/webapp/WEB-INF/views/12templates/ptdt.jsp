											...
											<div
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															...
															name="blc"	placeholder="比例尺"> 
																...
																data-placement="left" data-content="例如：1:250000"
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text"
															name="xzqy"	placeholder="行政区域"> <span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left" data-content="填至影像所涉及的县（市、区）例如：旬邑县"
																title="填写帮助" data-original-title="">?</span>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															...
															<input class="hide" type="text" name="fm"
																placeholder="幅面"> 
																<span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left"
																data-content="填写“两全开”、“全开”、“对开”、“四开”、“八开”等"
																title="填写帮助" data-original-title="">?</span>
														</div>
													</div>
