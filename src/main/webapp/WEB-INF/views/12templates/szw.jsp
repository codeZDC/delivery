											...
											<div
												...
												<div class="row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" id="szwm"
															name="szwm"	placeholder="水准网名">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" id="point"
															name="point"	placeholder="点数">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" id="lxcd"
															name="lxcd"	placeholder="路线长度">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" id="orwc"
															name="orwc"	placeholder="1km偶然中误差">
														</div>
													</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<select type="level">
															</select> <input class="hide" type="text" name="level"
																placeholder="等级">
														</div>
													</div>
