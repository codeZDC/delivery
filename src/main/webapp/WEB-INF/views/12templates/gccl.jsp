											...
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text"
															name="cd"	placeholder="长度"> <span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left" data-content="单位为“公里”"
																title="填写帮助" data-original-title="">?</span>
														</div>
													</div>
													<div class="form-group col-sm-6">
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<select type="gcclxmlb">
															</select> 
															<input class="hide" type="text" name="gcclxmlb"
																placeholder="项目类别"> 
																<span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left"
																data-content="填录“市政工程测量”、“水利工程测量”、“建筑工程测量”、“精密工程测量”等"
																title="填写帮助" data-original-title="">?</span>
														</div>
													</div>
												</div>
