											...
											<div
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															...
															name="mj"	placeholder="面积"> <span class="help-button"
																...
																data-placement="left" data-content="单位为“平方公里”" title="填写帮助"
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text"
															name="hsblc"	placeholder="航摄比例尺"> 
															<span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left" data-content="例如：1:8000" title="填写帮助"
																data-original-title="">?</span>
														</div>
													</div>
													<div class="form-group col-sm-6">
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text"
															name="jj"	placeholder="焦距"> 
															<span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left" data-content="单位为“毫米”" title="填写帮助"
																data-original-title="">?</span>
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text"
															name="xf"	placeholder="像幅"> 
															<span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left" data-content="例如：23厘米×23厘米" title="填写帮助"
																data-original-title="">?</span>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text"
															name="schpjlx"	placeholder="色彩或片基类型"> 
														</div>
													</div>
												</div>
											...
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" name="scdwmc"
																id="scdwmc" placeholder="施测单位名称">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
												...
												<div class="row">
													<div class="form-group center">
														<label class="control-label no-padding-right">是否副本</label>
															...
															<label class="inline"> <input value="0" checked="checked"
																name="iscopy" type="radio" class="ace">
