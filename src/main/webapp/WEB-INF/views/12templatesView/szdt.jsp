											...
											<div
												...
												<div class="row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="cgzl">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">数据格式</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="sjgs">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="ctff">xxxx项目</span>
															</div>
														</div>
													</div>
