										...
										<div class="widget-body" style="display: block;">
											<div
												...
												<div class="row">
													...
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">水准网名</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="szwm">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">路线长度</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="lxcd">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">1km偶然中误差</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="orwc">xxxx项目</span>
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="zbxt">xxx</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="gcxt">xxx</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="level">xxx</span>
															</div>
														</div>
													</div>
											...
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='scksnd'>2018.1.1</span>
															</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='scwcnd'>2018.1.1</span>
															</div>
														</div>
													</div>
												</div>
