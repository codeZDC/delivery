 ...
 */
@Table(name = "t_delivery_szw")
public class Szw extends BaseDomain {
    ...
    /**路线长度**/
    public String getLxcd(){
        return lxcd;
    }
    /**路线长度**/
    public void setLxcd(String lxcd){
        this.lxcd= lxcd;
    }
    /**1km偶然中误差**/
    public String getOrwc(){
        return orwc;
    }
    /**1km偶然中误差**/
    public void setOrwc(String orwc){
        this.orwc= orwc;
    }
    /**坐标系统**/
