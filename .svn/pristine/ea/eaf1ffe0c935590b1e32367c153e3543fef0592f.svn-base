										...
										<div class="widget-body" style="display: block;">
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">波段</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="bd">xxxx项目</span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">地面分辨率</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="dmfbl">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">卫星种类</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="wxzl">xxxx项目</span>
															</div>
														</div>
													</div>
