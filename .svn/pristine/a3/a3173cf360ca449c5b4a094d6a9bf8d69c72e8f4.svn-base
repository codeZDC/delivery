											...
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<select type="wxzl">
															</select> <input class="hide" type="text" name="wxzl"
																placeholder="卫星种类"> <span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left"
																data-content="“TM”、“SPOT”、“资源卫星二号”、“IKONOS”、“QuickBird”、“Landsat”等"
																title="填写帮助" data-original-title="">?</span>
														</div>
													</div>
