...
非、
														<div class="col-sm-8">
															...
															name="dlxxsjly"	placeholder="地理信息数据来源">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text"
															name="zyssly" placeholder="专业数据来源">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text"
															name="databasePla"	placeholder="数据库及系统开发软件平台">
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<select type="jsbz">
															</select> <input class="hide" type="text" name="jsbz"
																placeholder="采用的技术标准"> <span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left"
																data-content="如：《地理网格》（GB12409-1990）、《城市地理信息系统设计规范》（GB/T18578-2001）、《地下水资源分类分级标准》（GB/T15218-1994）等"
														...
														<div class="col-sm-8">
															<div class="input-medium">
																<div class="input-group">
																	...
																	name="scksnd"	id="dateBegin" type="text"
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="input-medium">
																<div class="input-group">
																	<input class="input-medium date-picker required"
																	name="scwcnd"	id="dateEnd" type="text"
																		data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd">
																	<span class="input-group-addon"> <i
																		class="ace-icon fa fa-calendar"></i>
																	</span>
