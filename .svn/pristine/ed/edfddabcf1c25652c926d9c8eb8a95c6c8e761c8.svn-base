 ...
 */
@Table(name = "t_delivery_wxyx")
public class Wxyx extends BaseDomain {
    ...
    /**地面分辨率**/
    public String getDmfbl(){
        return dmfbl;
    }
    /**地面分辨率**/
    public void setDmfbl(String dmfbl){
        this.dmfbl= dmfbl;
    }
    /**卫星种类**/
    ...
    /**卫星种类**/
    public void setWxzl(String wxzl){
        this.wxzl= wxzl;
    }
    /**范围**/
