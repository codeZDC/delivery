										...
										<div class="widget-body" style="display: block;">
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">系统名称</label>
													...
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">地理信息数据来源</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="dlxxsjly">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">专业数据来源</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="zyssly">xxxx项目</span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">数据库及系统开发软件平台</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="databasePla">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">采用的技术标准</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="jsbz">xxxx项目</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="input-medium">
																<div class="input-group">
																	<div class="profile-info-value">
																		<span class="editable editable-click" name="xsx">xxxx项目</span>
																	</div>
																</div>
															</div>
