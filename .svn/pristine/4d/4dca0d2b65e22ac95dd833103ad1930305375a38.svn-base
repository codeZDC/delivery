										...
										<div class="widget-body" style="display: block;">
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">图名</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="tm">xxxx项目</span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="blc">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">行政区域</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="xzqy">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">幅面</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="fm">xxxx项目</span>
															</div>
														</div>
													</div>
