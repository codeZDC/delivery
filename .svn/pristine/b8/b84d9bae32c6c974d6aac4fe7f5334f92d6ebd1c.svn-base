										...
										<div class="widget-body" style="display: block;">
											<div
												...
												<div class="row">
													...
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">摄区名称</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="sqmc">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">航摄仪型号</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="hsyxh">xxxx项目</span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="mj">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">航摄比例尺</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="hsblc">xxxx项目</span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">影像分辨率</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="yxfbl">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">焦距</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="jj">xxxx项目</span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">像幅</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="xf">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">色彩或片基类型</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="schpjlx">xxxx项目</span>
															</div>
														</div>
													</div>
												</div>
											...
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='scdwmc'>xxxx</span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='scdwContact'>xxxx</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='cgbgdwmc'>xxxx</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='cgbgdwContact'>xxxx</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='xmtzdwmc'>xxxx</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='ysjg'>xxxx</span>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='chfwzz'>xxxx</span>
															</div>
														</div>
													</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name='remarks'>xxxx</span>
															</div>
														</div>
													</div>
												</div>
