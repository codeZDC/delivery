 ...
 */
@Table(name = "t_delivery_gps")
public class Gps extends BaseDomain {
    ...
    /**平均误差**/
    public String getPjwc(){
        return pjwc;
    }
    /**平均误差**/
    public void setPjwc(String pjwc){
        this.pjwc= pjwc;
    }
    /**最弱边误差**/
    public String getZrbwc(){
        return zrbwc;
    }
    /**最弱边误差**/
    public void setZrbwc(String zrbwc){
        this.zrbwc= zrbwc;
    }
    /**坐标系统**/
