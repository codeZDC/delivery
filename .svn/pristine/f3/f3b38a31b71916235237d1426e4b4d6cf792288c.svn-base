										...
										<div class="widget-body" style="display: block;">
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">长度</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="cd">xxxx项目</span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
												...
												<div class="row">
													<div class="form-group col-sm-6">
														<label class="col-sm-4 control-label no-padding-right"
															for="form-field-username">项目类别</label>

														<div class="col-sm-8">
															<div class="profile-info-value">
																<span class="editable editable-click" name="gcclxmlb">xxxx项目</span>
															</div>
														</div>
													</div>
