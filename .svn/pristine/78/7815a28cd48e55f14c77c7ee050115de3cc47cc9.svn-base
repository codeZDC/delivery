											...
											<div
												...
												<div class="row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" 
															name="cgzl"	placeholder="成果种类">
															<span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left"
																data-content="例如：DRG、DEM、DOM、DLG"
																title="填写帮助" data-original-title="">?</span>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10" type="text" 
															name="sjgs"	placeholder="数据格式">
															<span class="help-button"
																data-rel="popover" data-trigger="hover"
																data-placement="left"
																data-content="例如：MBB、TIFF、DWG等格式"
																title="填写帮助" data-original-title="">?</span>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															...
															<input class="hide" type="text" name="wxzl"
															name="ctff"	placeholder="成图方法"> 
														</div>
													</div>
											...
											<div
												...
												<div class="row">
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input class="col-sm-12 col-sm-10 required numner" type="text"
